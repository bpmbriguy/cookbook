<div class="indent">
    <div class="wrapper">
        <div class="bg">
            <div id="recipeForm">
            <?php echo form_open_multipart('admin/edit/'.$recipe->recipe_id); ?>
            <?php echo form_fieldset('Recipe Information', array('id' => 'addRecipe')); ?>
            <ol>
                <li>
            <?php echo form_label('Recipe Name', 'name'); ?>
            <?php echo form_input('name', set_value('name', $recipe->name)); ?>
                </li>
                <li>
            ...
            <?php echo form_textarea(array(
                'name'  => 'ingredients',
                'id'    => 'ingredients',
                'value' => set_value('ingredients', $recipe->ingredients),
                'rows'  => 10,
                'cols'  => 50
            )); ?>
                </li>
            ...
            <?php echo form_textarea(array(
                'name'  => 'directions',
                'id'    => 'directions',
                'value' => set_value('directions', $recipe->directions),
                'rows'  => 10,
                'cols'  => 50
            )); ?>
                </li>
            ...
            <?php echo form_input('prep_time', set_value('prep_time', $recipe->prep_time)); ?>
                </li>
                <li>
            <?php echo form_label('Category', 'category'); ?>
            <?php echo form_dropdown('category', $categories, $recipe->category_category_id); ?>
                </li>
                <li>
            ...
            <?php echo form_dropdown('recipe_user_id', $user_select, $recipe->user_user_id); ?>
                </li>
            <?php endif; ?>
            </ol>
            <?php echo form_submit('submit', 'Submit'); ?>
            <?php echo form_fieldset_close(); ?>
            <?php echo form_hidden('recipe_id', $recipe->recipe_id); ?>
            <?php echo form_close(); ?>
